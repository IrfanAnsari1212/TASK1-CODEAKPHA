...
<head>
    ...
    <style>
        ...
        main {
            ...
            border-radius: 5px;
            box-shadow: 0 0 10px rgba(228, 236, 226, 0.1);
        }
        ...
        button {
            background-color: rgba(1, 13, 63, 0.826)
        ...
        button:hover {
            background-color: rgba(200, 101, 9, 0.886);
        }
    </style>
    <title><h1>Recipe Book Website</h1>h1></title>
</head>
<body>
    <header>
